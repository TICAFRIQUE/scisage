...
<section class="projects-section">
    <div class="container">
        ...
        <h2 class="section-title" data-aos="fade-up" data-aos-delay="100">
            Les étapes de votre projet {{ $activite->libelle }}
        </h2>

        @if($activite->projets && $activite->projets->count() > 0)
            <div class="projects-timeline">
                @foreach($activite->projets as $index => $projet)
                    <div class="timeline-item" data-aos="fade-up" data-aos-delay="{{ 200 + ($index * 100) }}">
        ...
        @else
            <div class="no-projects" data-aos="fade-up" data-aos-delay="200">
                ...
                <p>Les détails des étapes pour cette activité seront bientôt disponibles. Contactez-nous pour plus d'informations.</p>
            </div>
        @endif
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center" data-aos="fade-up">
                <h3 class="cta-title">Prêt à démarrer votre projet {{ $activite->libelle }} ?</h3>
