            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <i class="ri-bar-chart-line me-2"></i>Nouvelle statistique
                    </h4>
                </div>
                <div class="card-body">
                    <form id="formSend" action="{{ route('statistiques.store') }}" method="POST" 
                            ...
                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="libelle" id="libelle" class="form-control" required
                                                value="{{ old('libelle') }}" placeholder="Ex: Maisons construites">
                                            @error('libelle')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control" rows="4" 
                                        placeholder="Description détaillée de la statistique...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="card border mt-3">
                                    <div class="card-header">
                                        <h6 class="card-title mb-0">
                                            <i class="ri-image-line me-2"></i>Image <small class="text-muted">(optionnelle)</small>
                                        </h6>
                                    </div>
                                    <div class="card-body">
