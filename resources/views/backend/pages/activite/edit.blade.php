...
@section('content')
    @component('backend.components.breadcrumb')
        ...
        @endslot
        @slot('title')
            Modifier l'activité #{{ $activite->id }}
        @endslot
    @endcomponent
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <i class="ri-bar-chart-line me-2"></i>Modifier l'activité #{{ $activite->id }}
                    </h4>
                </div>
                <div class="card-body">
                    <form id="formSend" action="{{ route('activites.update', $activite->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="libelle" id="libelle" class="form-control"
                                                required value="{{ old('libelle', $activite->libelle) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control" rows="4"
                                        placeholder="Description détaillée de l'activité...">{{ old('description', $activite->description) }}</textarea>
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">
                                                    <i id="iconPreview" class="{{ $activite->icone }}"></i>
                                                </span>
                                                <input type="text" name="icone" id="icone" class="form-control"
                                                    required value="{{ old('icone', $activite->icone) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="position" id="position" class="form-control"
                                                value="{{ old('position', $activite->position) }}" min="1"
                                                max="100">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card border mt-3">
                                    ...
                                    <div class="card-body">
                                        @php
                                            $imageUrl = $activite->getFirstMediaUrl('image');
                                        @endphp
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="is_active" id="statut" class="form-select">
                                                <option value="1"
                                                    {{ old('is_active', $activite->is_active) ? 'selected' : '' }}>Actif
                                                </option>
                                                <option value="0"
                                                    {{ !old('is_active', $activite->is_active) ? 'selected' : '' }}>Inactif
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="bg-light rounded p-3">
                                            ...
                                            <small class="text-muted d-block">ID: #{{ $activite->id }}</small>
                                            <small class="text-muted d-block">Créée:
                                                {{ $activite->created_at->format('d/m/Y à H:i') }}</small>
                                            <small class="text-muted d-block">Modifiée:
                                                {{ $activite->updated_at->format('d/m/Y à H:i') }}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
