        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h5 class="card-title mb-0">Liste des apropos</h5>
                    <a href="{{ route('apropos.create') }}" type="button" class="btn btn-primary ">Créer
                        un apropos</a>
                </div>
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a href="{{ route('apropos.edit', $item->id) }}" type="button"
