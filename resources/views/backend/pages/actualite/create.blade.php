            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <i class="ri-folder-image-line me-2"></i>Nouvelle actualité
                    </h4>
                </div>
                <div class="card-body">
                    <form id="formSend" action="{{ route('actualites.store') }}" method="POST" class="needs-validation"
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-4">
                                    <label for="description" class="form-label">Description <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" id="ckeditor-classic" name="description" rows="5" required>
                                        {{ old('description') }}
                                    </textarea>
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card border mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-text">Image de couverture de l'actualité - Max 1MB (JPG, PNG, WebP)
                                        </div>
        ...
        $('#galerie').on('change', function(e) {
            ...
            if (newFiles.length > 0) {
                ...
                if (galerieFiles.length + uniqueNewFiles.length > 10) {
                    showError('galerie',
                        `Vous ne pouvez avoir que 10 images maximum. Vous avez déjà ${galerieFiles.length} images. ${uniqueNewFiles.length} nouvelles images uniques détectées.`
                    );
                    this.value = '';
                    return;
                }
                ...
                newFiles.forEach((file) => {
                    ...
                    if (file.size > 1 * 1024 * 1024) {
                        showError('galerie',
                            `L'image ${file.name} est trop volumineuse. Taille maximale: 1MB par image.`
                        );
                        hasError = true;
                        return;
                    }
