            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <i class="ri-bar-chart-line me-2"></i>Nouvel engagement
                    </h4>
                </div>
                <div class="card-body">
                    <form id="formSend" action="{{ route('engagements.store') }}" method="POST" class="needs-validation"
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="libelle" id="libelle" class="form-control"
                                                required value="{{ old('libelle') }}" placeholder="Ex: Transparence">
                                            @error('libelle')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="icone" id="icone" class="form-control"
                                                    required value="{{ old('icone') }}" placeholder="ri-home-line">
                                            </div>
                                            <div class="form-text">
                                                Icônes disponibles :
